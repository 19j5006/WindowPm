...
void setup()
{
  ...
  //myMovie3 = new Movie(this, "istockphoto-1331432006-640_adpp_is_SparkVideo.mp4");
  //myMovie4 = new Movie(this, "Seoul - 21116.mp4");
  movies = new Movie[4];
